En este repositorio se encuentra el proyecto de JavaScript con todos los archivos requeridos. Estos archivos contienen todo el código en HTML, CSS y JavaScript solicitado por el práctico.
